...
Domain: U.S. Monetary Policy since 2020. The topic was selected becaues of my interest in Monetary Policy, my background studying Central Banking. and relevance to Current Events.
  Problem: The Fed is very particular about its language regarding the future path of interest rates, noteably because it deliberately guides market expectations as a policy tool. Because of this, it is important to be able to parse the language and context of statements, in order to get an accurate picture of what the Fed is saying interest rates will do.
