...
class RAGDatabase:
    ...
    def __init__(self, db_path: str):
        # STORE PATH
        # Use the db_path passed by the caller (was incorrectly using DEFAULT_DB_PATH)
        self.db_path = db_path
        # Defer loading the (heavy) embedding model until it's actually needed
        # to avoid long startup time or network calls during simple checks.
        self.model = None
    ...
    def query(self, query_text: str, top_k: int = 10) -> list[dict]:
        ...
        try:
            ...
            # Ensure the embedding model is loaded (lazy load)
